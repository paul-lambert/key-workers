...
** Approximates a category of 'critical worker' based on UK SOC 2000 3-digit plus SIC-2007 codes 

** Using UK govt definition of 'critical workers' at 
...
** Assumes 'outvar' is a name for a new dummy variable that will indicate critical worker status, 
**   'invar1' is UK SOC2000 at 3-digit level, and 'invar2' is UK SIC2007 at 2-digit level 


capture drop $outvar 

gen $outvar=0 if $invar1 >= 111 & $invar1 <= 925 & $invar2 >= 1 & $invar2 <=  99 
...
**** Post-hoc corrections: adjustments to remove 'false positives' by inspection

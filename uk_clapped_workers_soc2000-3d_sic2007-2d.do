...
** Approximates a category of 'clapped worker' based on UK SOC 2000 3-digit plus SIC-2007 2-digit codes 


** Categorises occ or occ+industry circumstances on basis of public expressions of support in 
**   UK 'clap for carers' events 
...
** Assumes 'outvar' is a name for a new dummy variable that will indicate clapped-for worker status, 
...
*** Codes that assign to 'clapped for worker' on inspection of SOC or SOC/industry combination 
...
** All who work in health and social care industry: 
...
** Occupations that are universally clapped for: 
replace $outvar=1 if $invar1==116
...
** Occupations that are clapped for contingent upon industry (outside of health): 

replace $outvar=1 if ($invar1==711 | $invar1==712 | $invar1==925 | $invar1==924) & ($invar2==47) /* sales & security workers in retail */
replace $outvar=1 if ($invar2 >= 35 & $invar2 <= 39) & ($invar1 >= 511 & $invar1 <= 925)  /* manual workers in utilities */
replace $outvar=1 if ($invar1==923 | $invar1==924) & ///
    (($invar2 >= 49 & $invar2 <=53) | ($invar2==75 | $invar2==78 | $invar2==80 | $invar2==84 | $invar2==85) ) /* cleaners and security in public services */
